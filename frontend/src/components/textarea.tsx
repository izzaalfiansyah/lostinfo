...
export default function (props: Props) {
  ...
  return (
    <div class="mb-2">
      ...
      <textarea
        class="w-full focus:ring-2 focus:border-primary focus:ring-primary focus:ring-opacity-10 border-gray-100 transition resize-none p-1.5 px-3 disabled:bg-gray-100"
        {...others}
      />
